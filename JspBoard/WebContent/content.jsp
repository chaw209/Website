<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="ch.board.*,java.text.SimpleDateFormat"%>
<!DOCTYPE html>
<html>
<head>
<title>게시판</title>
...
<%
	//글상세보기=>상품리스트->상품의 정보를 자세히 (SangDetail.jsp)
	//list.jsp에서 링크->content.jsp?num=?&pageNum=?
