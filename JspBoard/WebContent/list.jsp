<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="ch.board.*,java.util.*,java.text.SimpleDateFormat" %>
<!DOCTYPE html>
<%!
     int pageSize=5;//numPerPage->페이지당 보여주는 게시물수(=레코드수)
     int blockSize=3;//pagePerBlock->블럭당 보여주는 페이지수 
     //작성날짜->우리나라 스타일 년-월-일 시분초->SimpleDateFormat 필요
		...
		<table border="1" width="700" cellpadding="0" cellspacing="0" align="center">
			...
			<%
	          for(int i=0;i<articleList.size();i++){
	             BoardDTO article=(BoardDTO)articleList.get(i);//articleList.elementAt(i) 벡터
    		%>
			<tr height="30">
			...
			<!-- num(게시물번호),pageNum(페이지번호)  
				링크걸기 할때 절대 공백, 다음줄로 개행->NumberFormatException
			-->
